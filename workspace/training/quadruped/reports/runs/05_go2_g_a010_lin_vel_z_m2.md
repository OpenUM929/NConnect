# 05. go2_g_a010_lin_vel_z_m2

- 시각: `2026-09-02_14-26-38` (학습 로그 내장값)
- 산출물: `workspace/_keep/go2_g_a010_lin_vel_z_m2`
- 학습: 1000/1000 iter, 로그 `workspace/_keep/go2_g_a010_lin_vel_z_m2/logs/candidate_training.log`
...
| `candidate` | 0.00000 | 19.79428 | 7 | `no_fall_detection` | POLICY_DOES_NOT_LOCOMOTE |
