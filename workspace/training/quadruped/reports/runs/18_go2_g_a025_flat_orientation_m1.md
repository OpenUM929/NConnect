# 18. go2_g_a025_flat_orientation_m1

- 시각: `2026-09-06_15-08-46` (학습 로그 내장값)
- 산출물: `workspace/_keep/go2_g_a025_flat_orientation_m1`
- **재현 회차**: `go2_g_a013_flat_orientation_m1`와 학습 지표 16000줄이 **완전히 일치**한다. 같은 학습이 두 번 나온 것이다.
- 학습: 1000/1000 iter, 로그 `workspace/_keep/go2_g_a025_flat_orientation_m1/logs/candidate_training.log`
