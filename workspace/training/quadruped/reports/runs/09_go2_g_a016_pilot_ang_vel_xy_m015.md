# 09. go2_g_a016_pilot_ang_vel_xy_m015

- 시각: `2026-09-04_21-00-12` (학습 로그 내장값)
- 산출물: `workspace/_keep/go2_g_a016_pilot_ang_vel_xy_m015`
- 학습: 1000/1000 iter, 로그 `workspace/_keep/go2_g_a016_pilot_ang_vel_xy_m015/logs/candidate_training.log`
...
|---|---|---|---|---|---|---|---|---|
| 200 | 0.1259 | 0.2884 | 940.11 | 0.1343 | 0.8657 | 8.86 | 0.48 | 7.5159 |
| 300 | 0.0005 | 0.2605 | 995.99 | 0.0156 | 0.9844 | 10.68 | 0.45 | 6.7388 |
| 500 | 0 | 0.252 | 988.02 | 0.0094 | 0.9906 | 12.87 | 0.43 | 6.2369 |
| 999 | 0 | 0.2509 | 995.99 | 0.0225 | 0.9775 | 13.27 | 0.43 | 6.3939 |
...
| `candidate` | 0.00000 | 1.37570 | 7 | `posture_gate_v1` | POLICY_DOES_NOT_LOCOMOTE |
