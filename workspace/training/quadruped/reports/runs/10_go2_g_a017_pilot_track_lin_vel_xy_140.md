# 10. go2_g_a017_pilot_track_lin_vel_xy_140

- 시각: `2026-09-04_22-24-51` (학습 로그 내장값)
- 산출물: `workspace/_keep/go2_g_a017_pilot_track_lin_vel_xy_140`
- 학습: 1000/1000 iter, 로그 `workspace/_keep/go2_g_a017_pilot_track_lin_vel_xy_140/logs/candidate_training.log`
...
|---|---|---|---|---|---|---|---|---|
| 200 | 0.481 | 0.473 | 970.73 | 0.0895 | 0.9105 | 12.24 | 0.54 | 9.2542 |
| 300 | 0.6042 | 0.3986 | 977.15 | 0.0406 | 0.9597 | 12.5 | 0.52 | 8.9502 |
| 500 | 0.8646 | 0.6531 | 955.52 | 0.0669 | 0.9331 | 15.71 | 0.54 | 9.3364 |
| 999 | 4.2503 | 0.8861 | 900.57 | 0.1061 | 0.8939 | 16.11 | 0.55 | 9.5362 |
...
| `candidate` | 0.00000 | 50.19916 | 7 | `posture_gate_v1` | POLICY_LOCOMOTES |
