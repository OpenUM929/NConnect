...
> 실험 로그와 대회용 기술 개선 리포트는 [`REPORTING_GUIDE.md`](REPORTING_GUIDE.md)를 따르고, 실제 작성은 [`TECHNICAL_IMPROVEMENT_REPORT_TEMPLATE.md`](TECHNICAL_IMPROVEMENT_REPORT_TEMPLATE.md)를 복사해 시작합니다.
