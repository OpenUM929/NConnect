"""Build and verify the Run06 fixed-evaluation upload package."""
...
OUTPUT = HUMANOID / "run06_fixed_eval_package.zip"
...
def inputs() -> list[Path]:
    paths = [
        ...
        HUMANOID / "server_run06_fixed_eval.sh",
        HUMANOID / "RUN06_FIXED_EVAL_README.txt",
...
def build() -> None:
    ...
    payload["RUN06_FIXED_EVAL_PACKAGE_SHA256SUMS.txt"] = manifest.encode("utf-8")
